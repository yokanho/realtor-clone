  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        />
        <div className="flex space-x-6 mb-">
          <div>
          ...
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input
                ...
                max="5000000000"
                required
                className="w-full px-4 py-2 text-xl test-gray-700 bg-white border border-color-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center"
              />
              {type === "rent" && (
                <div>
